...
npm run create-blog-post # Create new blog post (automated)
```
...
This project uses [shadcn/ui](https://ui.shadcn.com/) for consistent, accessible UI components. All components are customizable and built on top of Radix UI.
